...
class Runner extends Events__default["default"] {
    constructor() {
        super();
    ...
    async start(input) {
        ...
        for (let i = 0; i < this._stepList.length; i++) {
            ...
            console.log(chalk__default["default"].magenta.bold('[%s/%s]'), stepLabel, this._stepList.length, chalk__default["default"].greenBright(label));
            // eslint-disable-next-line @typescript-eslint/no-unsafe-assignment
